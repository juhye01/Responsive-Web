...
const imageList = [
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_01.png`,
    title: '가전나우 : 결제모듈',
    description: '결제 모듈 구축brewin”의 결제 시스템을 사용해, 플랫폼 결제 기능을 개발하였습니다',
  },
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_02.png`,
    title: '우아콘 : 디자인시스템',
    description: '기존의 복잡했던 코드 구조를 brewin"의 독자적인 라이브러리로 간소화했습니다',
  },
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_03.png`,
    title: '온누리 : 금융상품',
    description: 'brewin”의 결제 시스템을 사용해, 플랫폼 결제 기능을 개발했습니다',
  },
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_04.png`,
    title: 'CANAPE : 플러그인 적용',
    description: '디자인 시스템을 빠르게 적용하고 웹 개발을 진행했습니다',
  },
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_05.png`,
    title: 'mycointax : 앱 서비스',
    description: 'brewin"을 이용해 앱 서비스를 제작하였습니다',
  },
  {
    src: `${process.env.PUBLIC_URL}/img/portfolio_06.png`,
    title: 'Riid : 랜딩페이지',
    description: 'Riid 랜딩페이지 개발을 위해 brewin”을 도입하여 개발 시간을 단축시켰습니다',
  },
];
